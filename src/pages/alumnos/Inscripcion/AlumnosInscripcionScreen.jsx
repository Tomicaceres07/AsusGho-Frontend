      ...
      <section className="student__inscription__board">
        <div className="student__inscription__board-week">
          <div className="student__inscription__board-padding">
            ...
            <form
              className="student__inscription__form text-center"
            ...
            >
              ...
              <select
                ...
                className="student__inscription__dropdown w-100 mb-2 input"
              >
              ...
              <h4 className="student__inscription__title">
                Seleccione el curso
              </h4>
              <select
                name="division"
              ...
              {!isLoading ? (
                courses && courses.length >= 1 ? (
                  courses.map((item, courseIndex) => (
                    <div
                      className="text-start student__inscription__courses-container"
                      key={courseIndex}
                    >
              ...
              <div
                id="student__inscription__error"
