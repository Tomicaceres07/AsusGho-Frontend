  ...
  return (
    <div>
      ...
      <section className="student__absences__board">
        <h2 className="student__absences__board-title">
          Faltas: {totalAbscenses && totalAbscenses}
        </h2>
                ...
                abscenses.map((item, index) => (
                  <tr key={item.id}>
                    ...
                    <td
                      className={
                        item.justified === 0
                          ? "student__absences__board-unjustified"
                          : ""
                      }
                    >
                      {item.justified === 0 ? "Injustificada" : "Justificada"}
                    </td>
                  </tr>
                ))}
            </tbody>
