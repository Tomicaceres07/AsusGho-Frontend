    ...
    <div className="login__container">
      ...
      <div className="login__icons-container">
        <a
          ...
          href="https://twitter.com/liceopaz"
          target="_blank"
          rel="noreferrer"
        >
          <svg
        ...
        <a
          className="login__icon"
          href="https://www.facebook.com/Liceo-Militar-General-Paz-P%C3%A1gina-Oficial-277984185648274/"
          target="_blank"
          rel="noreferrer"
        >
          <svg
        ...
        <a
          className="login__icon"
          href="https://www.instagram.com/liceopaz/"
          target="_blank"
          rel="noreferrer"
        >
          <svg
